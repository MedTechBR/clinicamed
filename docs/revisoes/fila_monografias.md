# Fila: aprofundar as 84 leituras ao nível monografia (pedido de 24/09/2026)

Pedido do Matheus: "Quero que aprofunde todas". Brief: `docs/BRIEF_MONOGRAFIA.md` (versão 24/09).
Um redator por leitura, seis em paralelo, publicação a cada lote (junta_entradas → gera_indice →
...
Onda 7: [x] demencias-parkinson [x] doencas-neuromusculares [x] esclerose-multipla [x] tontura-e-vertigem [ ] artrite-reumatoide [x] lupus-vasculites
Onda 8: [x] cristais-espondilo [x] sjogren-esclerose-miopatias [ ] dor-musculoesqueletica [ ] glomerulopatias [ ] nefrolitiase-itu [ ] dialise-e-transplante
Onda 9: [ ] rim-e-farmacos [ ] rim-nas-doencas-sistemicas [ ] intoxicacoes [ ] politraumatizado [ ] via-aerea-e-intubacao [ ] ventilacao-mecanica
Onda 10: [ ] sedacao-analgesia-delirium [ ] nutricao-do-paciente-critico [ ] depressao-ansiedade [ ] bipolar-e-psicofarmacos [ ] psicose-agitacao-substancias [ ] insonia-e-sono
